...
<!--  -->
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="btn btn-dark" href="?page=s_sent">ส่งแล้ว</a>
          </li>

          <li class="nav-item">
            <a class="btn btn-dark" href="?page=interview_appointment">นัดสัมภาษณ์</a>
          </li>

          <!-- <li class="nav-item">
            <a class="btn btn-dark" href="?page=..">ถูกปฏิเสธ</a>
          </li> -->
